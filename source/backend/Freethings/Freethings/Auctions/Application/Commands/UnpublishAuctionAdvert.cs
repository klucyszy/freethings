...
public sealed record UnpublishAuctionAdvertCommand(
    Guid AuctionAdvertId) : IRequest<BusinessResult>;

internal sealed class UnpublishAuctionAdvertHandler : IRequestHandler<PublishAuctionAdvertCommand, BusinessResult>
{
    private readonly IAuctionAdvertRepository _repository;
    private readonly IEventBus _eventBus;
    private readonly ICurrentTime _currentTime;
    
    public UnpublishAuctionAdvertHandler(IAuctionAdvertRepository repository, IEventBus eventBus, ICurrentTime currentTime)
    {
